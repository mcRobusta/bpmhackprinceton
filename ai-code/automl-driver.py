...
workspace_name = "predict_health_insurance" # PLACEHOLDER
subscription_id = "1d0aa8d8-b0f7-4e8b-b6b3-48d84954d10a" # PLACEHOLDER
resource_group = "hackprinceton" # PLACEHOLDER
experiment_name = "predict_premiums" # PLACEHOLDER
iteration = "50"  # PLACEHOLDER
run_id = "AutoML_ce4ddc5d-c4a9-43a8-9754-fe23d6191326_50"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'compute_target':'genisys','enable_dnn':False,'experiment_exit_score':None,'experiment_timeout_minutes':180,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':180,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'predict_premiums','path':'./sample_projects/predict_premiums','primary_metric':'spearman_correlation','region':'eastus','resource_group':'hackprinceton','subscription_id':'1d0aa8d8-b0f7-4e8b-b6b3-48d84954d10a','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS2_V2','workspace_name':'predict_health_insurance','label_column_name':'charges','enable_run_restructure':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Stack_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.stack_ensemble\",\"class_name\":\"StackEnsemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'spearman_correlation','ensemble_iterations':15,'is_timeseries':False,'name':'predict_premiums','compute_target':'genisys','subscription_id':'1d0aa8d8-b0f7-4e8b-b6b3-48d84954d10a','region':'eastus'}\",\"ensemble_run_id\":\"AutoML_ce4ddc5d-c4a9-43a8-9754-fe23d6191326_50\",\"experiment_name\":\"predict_premiums\",\"workspace_name\":\"predict_health_insurance\",\"subscription_id\":\"1d0aa8d8-b0f7-4e8b-b6b3-48d84954d10a\",\"resource_group_name\":\"hackprinceton\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Stack_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"fa129af9-772f-49cd-a98a-6171b6dfdee9\"}}" # PLACEHOLDER
